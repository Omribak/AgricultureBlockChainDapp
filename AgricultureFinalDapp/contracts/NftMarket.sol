...
contract NftMarket is ERC721URIStorage,Ownable {
  ...
  constructor() ERC721("AgricultureNFT", "ANFT-app") {}
  ...
  function tokenOfOwnedByIndex(address owner , uint index) public view returns (uint) {
  ...
  function _beforeTokenTransfer(
    ...
    if(to==address(0)){
      ...
      _addTokenToOnwerEnumeration(to, tokenId);
    }
  }
  ...
  function _addTokenToAllTokensEnumeration(uint tokenId) private {
    ...
    function _addTokenToOnwerEnumeration(address to ,uint tokenId) private {
